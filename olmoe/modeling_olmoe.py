    ...
    def forward(
        ...
        **kwargs,
        ...
        if use_cache and past_key_values is not None:
            past_key_values_length = past_key_values.get_usable_length(seq_len) if hasattr(past_key_values, "get_usable_length") else past_key_values.get_seq_length()  # type: ignore
...
class OlmoeForCausalLM(OlmoePreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward("")
    @replace_return_docstrings(output_type=CausalLMOutputWithPast, config_class="OlmoeConfig")
    def forward(
        self,
        input_ids: Optional[torch.LongTensor] = None,
        attention_mask: Optional[torch.Tensor] = None,
        ...
        **kwargs,
        ...
        # Optional: compute auxiliary load balancing loss if requested (no custom output field)
