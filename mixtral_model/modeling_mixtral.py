...
def get_device(module):
    """
    Helper function to get device from a module.
    Works with both nn.Linear and quantized layers (QLinear, QuantLinear).
    """
...
class MixtralAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        hidden_states = hidden_states.to(get_device(self.q_proj))
...
class MixtralSparseMoeBlock(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, cur_sample: int=0) -> torch.Tensor:
        """ """
        hidden_states = hidden_states.to(get_device(self.experts[0].w1))
...
class MixtralForCausalLM(MixtralPreTrainedModel):
    ...
    def forward(
        ...
        hidden_states = hidden_states.to(get_device(self.lm_head))
